...
class Utils {
  ...
  /// 清空文件夹。
  static Future clearDirectory(String direct) async {
  ...
  static Future<void> extraFile(String zipPath, String extra2folderPath) async {
  ...
  // 打印日志
  static void mxLog(dynamic info) {
