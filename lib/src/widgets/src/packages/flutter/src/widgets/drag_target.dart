...
var _dragTarget = MXFunctionInvoke(
  ...
  ({
    ...
    onAcceptWithDetails: createValueChangedGenericClosure<DragTargetDetails<dynamic>>(_dragTarget.buildOwner, onAcceptWithDetails),
    onLeave: createValueChangedGenericClosure<Object>(_dragTarget.buildOwner, onLeave),
    onMove: createValueChangedGenericClosure<DragTargetDetails<dynamic>>(_dragTarget.buildOwner, onMove),
  ),
  [
    "key",
    "builder",
