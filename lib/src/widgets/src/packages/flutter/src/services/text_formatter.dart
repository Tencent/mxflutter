...
Map<String, MXFunctionInvoke> registerTextFormatterSeries() {
  ...
  m[_filteringTextInputFormatter_allow.funName] = _filteringTextInputFormatter_allow;
  m[_filteringTextInputFormatter_deny.funName] = _filteringTextInputFormatter_deny;
...
var _filteringTextInputFormatter_allow = MXFunctionInvoke(
...
var _filteringTextInputFormatter_deny = MXFunctionInvoke(
