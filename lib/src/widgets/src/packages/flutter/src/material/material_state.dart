...
Map<String, MXFunctionInvoke> registerMaterialStateSeries() {
  ...
  m[_materialStateMouseCursor_clickable.funName] = _materialStateMouseCursor_clickable;
  m[_materialStateMouseCursor_textable.funName] = _materialStateMouseCursor_textable;
  return m;
}
var _materialState = MXFunctionInvoke(
  ...
  ["name", "index"]
 );var _materialStateMouseCursor_clickable = MXFunctionInvoke(
  "MaterialStateMouseCursor.clickable",
  () => MaterialStateMouseCursor.clickable
);
var _materialStateMouseCursor_textable = MXFunctionInvoke(
