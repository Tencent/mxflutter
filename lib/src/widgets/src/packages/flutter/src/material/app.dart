...
Map<String, MXFunctionInvoke> registerAppSeries() {
  ...
  m[_materialApp_router.funName] = _materialApp_router;
  return m;
}
...
var _materialApp = MXFunctionInvoke(
  ...
  ({
    ...
    // MX Modified begin Iterable<ui.Locale> -> Iterable<dynamic>
    Iterable<dynamic> supportedLocales = const <Locale>[
      ui.Locale('en', 'US')
    ],
    // MX Modified end
    ...
    localeResolutionCallback: null,
        // MX Modified begin - MXJSC-Modifed
    supportedLocales:List<ui.Locale>.from(supportedLocales),
        // MX Modified end
...
var _materialApp_router = MXFunctionInvoke(
  "MaterialApp.router",
  ({
    Key key,
    ...
    dynamic localeListResolutionCallback,
    dynamic localeResolutionCallback,
    Iterable<ui.Locale> supportedLocales = const <Locale>[
      ui.Locale('en', 'US')
    ],
    bool debugShowMaterialGrid = false,
    bool showPerformanceOverlay = false,
